...
<template>
  <div class="studentAcc">
    <HeaderComp class="asd" textHeader="MANAGER" />
...
export default {
  ...
  mounted() {
    ...
    console.log(import.meta.env.VITE_MANAGER_LOGIN);
  },

  methods: {
    send() {
      if (this.login !== import.meta.env.VITE_MANAGER_LOGIN && this.password !== import.meta.env.VITE_MANAGER_PASSWORD) {
        this.mistake = true
      } else {
...
section::before {
  ...
  width: 100%;
  height: 100%;
  background: linear-gradient(#000000, #FF4508, #000000);
